...
##For Plot 3
png(height=480,width=480,units="px",filename="C:/Users/uma.aiyer/Documents/RLearning/plot3.png",bg="transparent")
plot(needed2$DateTime,as.numeric(as.character(needed2$Sub_metering_1)),type="l",xlab=" ",ylab="Energy Sub Metering")
...
legend("topright", col = c("black", "red", "blue"), lty = c("solid", "solid", "solid"), legend = names(needed2[,7:9]),x.intersp=0.6)
dev.off()